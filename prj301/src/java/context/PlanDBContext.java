...
public class PlanDBContext extends DBContext<Plan>{
    ...
    public void insert(Plan entity) {
        try {
            ...
            Logger.getLogger(context.PlanDBContext.class.getName()).log(Level.SEVERE, null, ex);
            try {
                connection.rollback();
            } catch (SQLException ex1) {
                Logger.getLogger(context.PlanDBContext.class.getName()).log(Level.SEVERE, null, ex1);
            }
        } finally {
            try {
